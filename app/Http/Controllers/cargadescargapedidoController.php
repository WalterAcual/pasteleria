...
class cargadescargapedidoController extends Controller
{
    ...
    public function index(Request $request){
        ...
        if ($request){  
            ...
            $cargadescarga->whereRaw('cargadescarga.idtipocargadescarga = 2');
            $cargadescarga = $cargadescarga->orderBy('cargadescarga.idcargadescarga', 'desc')->paginate(10);
            return view ('cargadescarga.cargadescargapedido.index', ["cargadescarga"=>$cargadescarga, "searchText"=>$query,  "_estado" =>$_estado]);
        }
    }
    ...
    public function create(){	
        return view("cargadescarga.cargadescargapedido.create");
    }
    ...
    public function store(cargadescargaFormRequest $request){
        ...
        $cargadescargamodelo->idtipocargadescarga="2";
        $cargadescargamodelo->idcliente=$request->get('idcliente');
        ...
        return Redirect::to('cargadescarga/cargadescargapedido'); //retorna al usuario a listado de grados a URL	
    }

    public function show($idcargadescarga){
        return view ('cargadescarga.cargadescargapedido.show', ["cargadescarga"=>cargadescargamodelo::findorfail($idcargadescarga)]); //muestra por id de Categoria
    }

    public function edit($idcargadescarga){
        return view ('cargadescarga.cargadescargapedido.edit', ["cargadescarga"=>cargadescargamodelo::findorfail($idcargadescarga)]);//paramtero recibido id
    }
    ...
    public function update(cargadescargaFormRequest $request, $idcargadescarga){
        ...
        return Redirect::to('cargadescarga/cargadescargapedido');
    }
    ...
    public function destroy($idcargadescarga){
        ...
        return Redirect('cargadescarga/cargadescargapedido');
    }
