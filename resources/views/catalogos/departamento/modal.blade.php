...
role="dialog" tabindex="-1" id="modal-delete-{{$productStatus->estado}}">
		{{Form::Open(array('action'=>array('pasteltatusController@destroy',$productStatus->estado), 'method'=>'delete'))}}	
