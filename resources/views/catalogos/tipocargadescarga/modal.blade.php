...
role="dialog" tabindex="-1" id="modal-delete-{{$tipotra->idtipocargadescarga}}">
		{{Form::Open(array('action'=>array('tipocargadescargaController@destroy',$tipotra->idtipocargadescarga), 'method'=>'delete'))}}	
