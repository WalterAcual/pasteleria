...
role="dialog" tabindex="-1" id="modal-delete-{{$categorias->idcategoria}}">
		{{Form::Open(array('action'=>array('categoriaController@destroy',$categorias->idcategoria), 'method'=>'delete'))}}	
