...
<div class="row">
	<div class = "col-lg-8 col-md-8 col-sm-8 col-xs-12 titlecatalogos">
		<h2>Ventas: </h2> <a href="cargadescargapedido/create"><button class="btn btn-primary"><i class="fa fa-plus"></i> Agregar</button> </a> <h4></h4>
		@include ('cargadescarga.cargadescargapedido.search')
	</div>
</div>
		...
		<div class="">	
			<table class ="table table-striped table-bordered table-condensed table-hover">
				...
				<tr>
					...
					<td class="table-active">{{$cargade->nombrecliente}}</td>
					...
					<td>
						<a href="../listacargadescargadetallepedido/{{$cargade->idcargadescarga}}"><button class="btn btn-outline-primary"><i class="fa fa-eye"></i></button></a>
					</td>
				</tr>
