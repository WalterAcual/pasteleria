...
<script type="text/javascript">
	document.addEventListener('DOMContentLoaded', function(){
		...
		$("#btnAgregarpastel").click(function(){
			...
			if(strpastel > 0 && strcantidad > 0 && strprecio > 0){
				var subtotal = strcantidad * strprecio;
                $.ajax({
                    url: '/postdetallecompra',
                    type: 'POST',
                    data: {_token: CSRF_TOKEN, idcargadescarga:strcargadescarga, idpastel:strpastel, cantidad:strcantidad, precio:strprecio, subtotal:subtotal},
                    dataType: 'JSON',
				...
				var url = "../listacargadescargadetallecompra/" + strcargadescarga;
...
<div>
	...
	<table class="row">
        ...
        <tr>
			...
			<td>
				@if(($idestado) == 1)
					<button id="btnAplicar" class= "btn btn-success text-light" title="Regresar">Validar</button>
				@endif		
			</td>
			<td>
...
<div class="" style="text-align: lefth; width=300">
	<table>
		<tr>
			<td>
				<a href="../cargadescarga/cargadescargacompra"><button id="regresarcargadescarga" class= "btn btn-secondary text-light" title="Regresar">Regresar</button></a>
			</td>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		</tr>
	</table>
